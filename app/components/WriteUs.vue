<template>
  <ScrollView class="text-center" :style="backgroundColor">
    <StackLayout padding="10">
      <Label fontSize="22" class="m-t-25 bold" :style="primaryTextColor" opacity="0.5">{{ $t('writeUs') }}</Label>
      <Label fontSize="14" fontWeight="300" textWrap="true" opacity="0.7" class="m-y-10" :style="secondaryTextColor" >{{ $t('sendUs') }}</Label>
